...
import { ZSimpleGridLayoutTemplate } from './src/lib/components/simple-grid-layout/simple-grid-layout-interfaces';
...
generateJSONSchemaFromZodTypes([ZSimpleGridLayoutTemplate]);
