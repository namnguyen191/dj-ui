...
import { ZSimpleImageUIESchema } from './simple-image/src';
import { ZSimpleTextUIESchema } from './simple-text/src';
...
generateJSONSchemaFromZodTypes([ZSimpleTextUIESchema, ZSimpleImageUIESchema]);
